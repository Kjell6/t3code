        ...
        <div className="grid grid-cols-2 gap-2">
          {actions.map((action) => {
            ...
            if (action.available) {
              return (
                <button
                  ...
                  className="flex min-h-28 w-full flex-col items-start rounded-lg border border-border/80 bg-neutral-100/60 p-4 text-left transition hover:border-border hover:bg-accent/60 dark:bg-neutral-800/60"
                >
                  {content}
                </button>
              );
            ...
            const disabledCard = (
              <button
                type="button"
                className="flex min-h-28 w-full cursor-not-allowed flex-col items-start rounded-lg border border-border/80 bg-neutral-100/60 p-4 text-left opacity-40 dark:bg-neutral-800/60"
                aria-disabled="true"
              >
                {content}
              </button>
